...
// Final Checkpoint
$Event(98006000, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4, X24_4) {
    WaitFor(ActionButtonInArea(5110, X0_4));
    
    DisplayStatusMessage(500000, 1);
    WaitFixedTimeSeconds(1.0);
    SetSpEffect(10000, 7001020); // Display Course Time
    
    WaitFixedTimeSeconds(10.0);
    
    WarpPlayer(X12_4, X16_4, X20_4, X24_4, X4_4, -1);
    SetPlayerRespawnPoint(X8_4);
});

// Checkpoint
$Event(98006001, Default, function(X0_4, X4_4, X8_8) {
    EndIf(EventFlag(X8_8));
    
    WaitFor(ActionButtonInArea(5100, X0_4));
    
    SetPlayerRespawnPoint(X4_4);
    SetEventFlagID(X8_8, ON);
    
    DisplayStatusMessage(500010, 1);
    WaitFixedTimeSeconds(1.0);
    SetSpEffect(10000, 7001020); // Display Course Time
});

// Trap Loop (1)
$Event(98006100, Default, function(X0_4, X4_4, X8_4) {
    // Delay
    WaitFixedTimeSeconds(X8_4);
...
// Trap Knockback Monitor (1)
$Event(98006101, Default, function(X0_4, X4_4) {
    if(EventFlag(X0_4) && InArea(10000, X4_4, 1))
    {
        SetSpEffect(10000, 7002000);
    }
...
// Trap Loop (2)
$Event(98006110, Default, function(X0_4, X4_4, X8_4, X12_4) {
    // Delay
    WaitFixedTimeSeconds(X12_4);
...
// Trap Knockback Monitor (2)
$Event(98006111, Default, function(X0_4, X4_4, X8_4) {
    if(EventFlag(X0_4))
    {
        if(InArea(10000, X4_4, 1) || InArea(10000, X8_4, 1))
        {
            SetSpEffect(10000, 7002000);
        }
    }
...
// Trap Loop (3)
$Event(98006120, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4) {
    // Delay
    WaitFixedTimeSeconds(X16_4);
...
// Trap Knockback Monitor (3)
$Event(98006121, Default, function(X0_4, X4_4, X8_4, X12_4) {
    if(EventFlag(X0_4))
    {
        if(InArea(10000, X4_4, 1) || InArea(10000, X8_4, 1) || InArea(10000, X12_4, 1))
        {
            SetSpEffect(10000, 7002000);
        }
    }
...
// Trap Loop (4)
$Event(98006130, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4) {
    // Delay
    WaitFixedTimeSeconds(X20_4);
    ...
    DeleteMapSFX(X8_4, 0);
    DeleteMapSFX(X12_4, 0);
    DeleteMapSFX(X16_4, 0);
    SetEventFlagID(X0_4, OFF);
    
    RestartEvent();
});

// Trap Knockback Monitor (4)
$Event(98006131, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4) {
    if(EventFlag(X0_4))
    {
        if(InArea(10000, X4_4, 1) || InArea(10000, X8_4, 1) || InArea(10000, X12_4, 1) || InArea(10000, X16_4, 1))
        {
            SetSpEffect(10000, 7002000);
        }
    }
...
// Trap Loop (5)
$Event(98006140, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4, X24_4) {
    // Delay
    WaitFixedTimeSeconds(X24_4);
    ...
    DeleteMapSFX(X12_4, 0);
    DeleteMapSFX(X16_4, 0);
    DeleteMapSFX(X20_4, 0);
    SetEventFlagID(X0_4, OFF);
    
    RestartEvent();
});

// Trap Knockback Monitor (5)
$Event(98006141, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4) {
    if(EventFlag(X0_4))
    {
        if(InArea(10000, X4_4, 1) || InArea(10000, X8_4, 1) || InArea(10000, X12_4, 1) || InArea(10000, X16_4, 1) || InArea(10000, X20_4, 1))
        {
            SetSpEffect(10000, 7002000);
        }
    }
...
// Course Reset
$Event(98006200, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4) {
    WaitFor(CharacterHasSpEffect(10000, 7001030, Equal, 1));
    
    WarpPlayer(X8_4, X12_4, X16_4, X20_4, X0_4, -1);
    SetPlayerRespawnPoint(X4_4);
});

// Timer Reset
$Event(98006201, Default, function(X0_4) {
    WaitFor(InArea(10000, X0_4, 1));
    
    ClearEventValue(1047590000, 10);
    ClearEventValue(1047590200, 10);
    ClearEventValue(1047590400, 10);
});
